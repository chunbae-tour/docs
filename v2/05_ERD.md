...
<img src="./assets/erd/00_full_erd.png" alt="춘배투어 전체 상세 ERD" width="100%" />

## 0-1. 도메인 ERD 개요

<img src="./assets/erd/01_domain_overview.png" alt="춘배투어 도메인 ERD 개요" width="100%" />

## 0-2. 도메인별 상세 ERD

### 1. 인증·유저·제재 도메인

<img src="./assets/erd/02_user.png" alt="인증 유저 제재 도메인 ERD" width="100%" />

### 2. 커뮤니티 도메인

<img src="./assets/erd/03_community.png" alt="커뮤니티 도메인 ERD" width="100%" />

### 3. 동행·리뷰·채팅 도메인

<img src="./assets/erd/04_chat.png" alt="동행 리뷰 채팅 도메인 ERD" width="100%" />

### 4. 관광지·전통시장·축제 도메인

<img src="./assets/erd/05_place.png" alt="관광지 전통시장 축제 도메인 ERD" width="100%" />

### 5. 가게·상인 도메인

<img src="./assets/erd/06_shop.png" alt="가게 상인 도메인 ERD" width="100%" />

### 6. 결제·스토어·엽전 도메인

<img src="./assets/erd/07_pay.png" alt="결제 스토어 엽전 도메인 ERD" width="100%" />

### 7. CS·신고·감사·알림·기타 도메인

<img src="./assets/erd/08_cs_report_etc.png" alt="CS 신고 감사 알림 기타 도메인 ERD" width="100%" />
